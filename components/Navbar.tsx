                ...
                <div className="flex items-center gap-8">
                    ...
                    <ul className="hidden md:flex items-center gap-8 text-[15px] font-medium text-gray-800">
                        ...
                        >
                            ...
                            <div
                                className={`
                                    absolute left-0 top-full w-56 mt-2 bg-white rounded-md shadow-lg
                            ...
                            >
                                <ul className="space-y-3">
                                    <li>
                                        <Link href="/about" className="dropdown-link-clean flex items-center gap-2">
                                            <FaBuilding className="text-[#3B82F6]" />
                                            We Are Quasent
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        >
                            ...
                            >
                                <ul className="space-y-1">
                                    ...
                                    <li className="relative group/solutions">
                                        <button className="flex items-center justify-between w-full px-2 py-2 hover:bg-gray-100 rounded text-sm text-gray-700">
                                            <span className="flex items-center gap-2">
                                                <FaBriefcase className="text-[#A855F7]" />
                                                Our Solutions
                                            </span>
                                            <FaChevronDown className="rotate-[-90deg] text-gray-500 text-xs" />
                                        </button>

                                        <div
                                            className="
                                                absolute left-full top-0 ml-2 w-56 bg-white border border-gray-200
                                                rounded-md shadow-lg p-3 opacity-0 invisible group-hover/solutions:opacity-100
                                                group-hover/solutions:visible transition-all duration-150
                                            "
                                        >
                                            <ul className="space-y-3">
                                                <li>
                                                    <Link href="/permanent-hire" className="dropdown-link-clean flex items-center gap-2">
                                                        <FaUserTie className="text-[#A855F7]" />
                                                        Permanent Work Hires
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link href="/contractors-workforce" className="dropdown-link-clean flex items-center gap-2">
                                                        <FaUserCog className="text-[#F59E0B]" />
                                    ...
                                    <li>
                                        <Link href="/submit-vacancy" className="dropdown-link-clean flex items-center gap-2">
                                            <FaPlusCircle className="text-[#3B82F6]" />
                                            Submit a Vacancy
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        >
                            ...
                            <div
                                className={`
                                    absolute left-0 top-full w-56 mt-2 bg-white rounded-md shadow-lg
                                    border border-gray-100 p-4 z-50 transition-all duration-150
                                    ${openDropdown === "candidates" ? "opacity-100 visible" : "opacity-0 invisible"}
                                `}
                            >
                                <ul className="space-y-3">
                                    <li>
                                        <Link href="/contractors" className="dropdown-link-clean flex items-center gap-2">
                                            <FaUserShield className="text-[#8B5CF6]" />
                                            Contractors
                                        </Link>
                                    </li>

                                    <li>
                                        <Link href="/submit-cv" className="dropdown-link-clean flex items-center gap-2">
                                            <FaFileUpload className="text-[#F97316]" />
                                            Submit Your CV
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        <li>
                            <Link href="/join-us" className="flex items-center gap-2 hover:text-gray-900 transition">
